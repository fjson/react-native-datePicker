...
public class MyPickerView extends RelativeLayout {
    ...
    public MyPickerView(Context context, AttributeSet attrs) {
        ...
        try {
            startCalendar.setTime(sdf.parse("2007-01-01 00:00"));
            endCalendar.setTime(sdf.parse("2020-01-01 00:00"));
    ...
    public void freshView(){
        initParameter();
        initTimer();
        setSelectedTime(sdf.format(new Date()));
        invalidate();
    }

    public void setStartTime(String minDate){
        try {
            startCalendar.setTime(sdf.parse(minDate));
            freshView();
        } catch (ParseException e) {
            e.printStackTrace();
        }
    ...
    public void setEndTime(String minDate){
        try {
            endCalendar.setTime(sdf.parse(minDate));
            freshView();
        } catch (ParseException e) {
            e.printStackTrace();
        }
    ...
    private void initView() {
        year_pv =  findViewById(R.id.year_pv);
    ...
    public void setResultHandlerListener(ResultHandler resultHandler){
...
//            minute_pv.setSelected(0);
    ...
    public void onReceiveNativeEvent(long mDate) {
            WritableMap event = Arguments.createMap();
            event.putString("message", mDate+"");
